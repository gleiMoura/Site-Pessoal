const data = [
	...
	{site: 'https://projeto13-mywallet-front-six-sigma.vercel.app/', text: 'Aplicação FULLSTACK de um organizador financeiro que utiliza REACT no front, API Rest com Express no back e MONGODB no banco de dados! Utiliza Cypress para fazer teste E2E', title: 'My Wallet', backLink:'https://github.com/gleiMoura/projeto13-mywallet-back', backText:'Mywallet Back-end'},
